...
### amber messy ####
comment(UKB_master$sex)<-c("Datafield=31.0.0")
comment(UKB_master$age)<-c("Datafield = 21003.0.0")
comment(UKB_master$year_born)<-c("Datafield = 34.0.0")
comment(UKB_master$month_born)<-c("Datafield = 52.0.0")
comment(UKB_master$ethnicity)<-c("Datafield = 21000.0.0")
comment(UKB_master$assess_date)<-c("Datafield = 53.0.0")
comment(UKB_master$assess_centre)<-c("Datafield = 54.0.0")
comment(UKB_master$assess_name)<-c("derived field")
comment(UKB_master$assess_latitude)<-c("derived field")
comment(UKB_master$assess_longitude)<-c("derived field")
comment(UKB_master$urban)<-c("Datafield = 20118.0.0")
comment(UKB_master$deprivation_index_england )<-c("Datafield = 26410.0.0")
comment(UKB_master$deprivation_index_scotland )<-c("Datafield = 26427.0.0")
comment(UKB_master$deprivation_index_wales )<-c("Datafield = 26426.0.0")
comment (UKB_master$age_completed_education)<-c("Datafield = 845")
comment(UKB_master$qualifications)<-c("Datafield = 6138")
comment(UKB_master$employed)<-c("Datafield = 6142")
comment(UKB_master$employed_corr)<-c("Datafield = 20119")
comment(UKB_master$night_shift)<-c("Datafield = 3426")
comment(UKB_master$shift_work)<-c("Datafield = 826")
comment(UKB_master$adopted)<-c("Datafield = 1767")
comment(UKB_master$birth_weight)<-c("Datafield = 20022")
comment(UKB_master$birth_weight_metric)<-c("Datafield = 120")
comment(UKB_master$breastfed)<-c("Datafield = 1677")
comment(UKB_master$country_birth_nonuk)<-c("Datafield = 20115")
...
comment(UKB_master$medication_number)<-c("Datafield = 137")
comment(UKB_master$medication_code)<-c("Datafield = 20003")
comment(UKB_master$disability_allowance)<-c("Datafield = 6146")
comment(UKB_master$disability_self_report)<-c("Datafield = 2188")
comment(UKB_master$depress_psych)<-c("Datafield = 2100")
comment(UKB_master$depress_gp)<-c("Datafield = 2090")
comment(UKB_master$time_outdoors_summer)<-c("Datafield = 1050")
comment(UKB_master$time_outdoors_winter)<-c("Datafield = 1060")
comment(UKB_master$sleep_duration)<-c("Datafield = 1160")
comment(UKB_master$getting_up)<-c("Datafield = 1170")
comment(UKB_master$chronotype)<-c("Datafield = 1180")
comment(UKB_master$day_naps)<-c("Datafield = 1190")
comment(UKB_master$insomnia)<-c("Datafield = 1200")
comment(UKB_master$snoring)<-c("Datafield = 1210")
comment(UKB_master$day_sleepiness)<-c("Datafield = 1220")
comment(UKB_master$alcohol_yesterday)<-c("Datafield = 100580")
comment(UKB_master$accel_mean)<-c("Datafield = 90012.0.0")
comment(UKB_master$systolic)<-c("Datafield = 4080.0.0")
comment(UKB_master$diastolic)<-c("Datafield = 4079.0.0")
comment(UKB_master$pulse)<-c("Datafield = 102.0.0")
comment(UKB_master$body_fat)<-c("Datafield = 23099.0.0")
comment(UKB_master$BMI)<-c("Datafield = 21001.0.0")
comment(UKB_master$handgrip_l)<-c("Datafield = 46")
comment(UKB_master$handgrip_r)<-c("Datafield = 47")
comment(UKB_master$FEV)<-c("Datafield = 3063")
comment(UKB_master$FVC)<-c("Datafield = 3062")
comment(UKB_master$PEF)<-c("Datafield = 3064")
comment(UKB_master$julian_day)<-c("derived field")
comment(UKB_master$prev_julian_day)<-c("derived field")
comment(UKB_master$daylength_min)<-c("derived field")
comment(UKB_master$prev_daylength_min)<-c("derived field")
comment(UKB_master$photoperiod_roc_min)<-c("derived field")
comment(UKB_master$photoperiod_roc_percent)<-c("derived field")
comment(UKB_master$assess_month)<-c("derived from Datafield = 53")
comment(UKB_master$assess_year)<-c("derived from Datafield = 53")
comment(UKB_master$end_biometrics)<-c("Datafield = 21834")
